...
function preload() {
    ...
    IsoGame.load.spritesheet('hero', 'http://john-lay.github.io/games/quest/Images/spritesheet-bicubic.png', 30, 48, 3);
    IsoGame.load.spritesheet('zombie', 'http://john-lay.github.io/games/quest/Images/spritesheet-bicubic-85h.png', 30, 48, 3);
}
function create() {
    Draw.grid();
    Draw.hero(8, 6);
...
function moveToDestination(sprite, tile) {
    setTimeout(function () {
