...
var routes = [
    { path: '/genesis-techical-assessment', pathMatch: 'full', redirectTo: '', component: __WEBPACK_IMPORTED_MODULE_2__shared_components_shot_list_shot_list_component__["a" /* ShotListComponent */] },
